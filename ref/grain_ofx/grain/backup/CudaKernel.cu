...
extern void RunCudaKernel(int p_Width, int p_Height, float p_muR, float p_sigmaR, float p_NmonteCarlo, float p_sigmaFilter, int p_seed, float p_blend, float* p_Input, float* p_Output, int p_rnd)
{
    ...
    getTextureMap(p_Input + 0, p_Output + 0, p_Width, p_Height, p_muR/2, p_sigmaR, p_NmonteCarlo, p_sigmaFilter, p_seed*2023*p_rnd);
    getTextureMap(p_Input + 1, p_Output + 1, p_Width, p_Height, p_muR/2, p_sigmaR, p_NmonteCarlo, p_sigmaFilter, p_seed*2023*p_rnd);
    getTextureMap(p_Input + 2, p_Output + 2, p_Width, p_Height, p_muR/2, p_sigmaR, p_NmonteCarlo, p_sigmaFilter, p_seed*2023*p_rnd);
